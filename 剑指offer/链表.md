...
function clone(list) {
    ...
    while(current && current.next ) {
        let newNode = newList.insert(current.next.element,current.element);
...
let node1 = llist.insert('1','head');
let node2 = llist.insert('2','1');
let node3 = llist.insert('3','2');
let node4 = llist.insert('4','3');
